...
function drawViz(data) {
    ...
    function allFormatting(x, missingValue) {
        if (isNaN(x) || x === null) {
            return missingValue;
        };
    ...
    for (var i = 1; i < data.tables.DEFAULT.rows[0].length - titleMetricAdjust; i++) {
        ...
        comparisonMetrics[i] = defaultTable.rows[0][i];
    };
    console.log(comparisonMetrics);
    console.log(comparisonMetrics[0]);
    console.log(comparisonMetrics[1]);
    console.log(comparisonMetrics[2]);
    ...
    function replaceAll(str) {
        var mapObj = {
            ...
            "{comparisonMetric1}": comparisonMetrics[1],
            "{comparisonMetric2}": comparisonMetrics[2],
            "{comparisonMetric3}": comparisonMetrics[3],
            "{comparisonMetric4}": comparisonMetrics[4],
            "{comparisonMetric5}": comparisonMetrics[5],
            "{comparisonMetric6}": comparisonMetrics[6],
            "{comparisonMetric7}": comparisonMetrics[7],
            "{comparisonMetric8}": comparisonMetrics[8],
            "{comparisonMetric9}": comparisonMetrics[9],
            "{comparisonMetric10}": comparisonMetrics[10],
            "{comparisonMetric11}": comparisonMetrics[11],
            "{comparisonMetric12}": comparisonMetrics[12],
            "{comparisonMetric13}": comparisonMetrics[13],
            "{comparisonMetric14}": comparisonMetrics[14],
            "{comparisonMetric15}": comparisonMetrics[15],
            "{comparisonMetric16}": comparisonMetrics[16],
            "{comparisonMetric17}": comparisonMetrics[17],
            "{comparisonMetric18}": comparisonMetrics[18],
            "{comparisonMetric19}": comparisonMetrics[19],
            "{comparisonMetric20}": comparisonMetrics[20],
            "{comparisonMetric21}": comparisonMetrics[21],
            "{comparisonMetric22}": comparisonMetrics[22],
            "{comparisonMetric23}": comparisonMetrics[23],
            "{comparisonMetric24}": comparisonMetrics[24],
            "{comparisonMetric25}": comparisonMetrics[25],
            "{comparisonMetric26}": comparisonMetrics[26],
            "{comparisonMetric27}": comparisonMetrics[27],
            "{comparisonMetric28}": comparisonMetrics[28],
            "{comparisonMetric29}": comparisonMetrics[29],
            "{comparisonMetric30}": comparisonMetrics[30],
            "{comparisonMetric31}": comparisonMetrics[31],
            "{comparisonMetric32}": comparisonMetrics[32],
            "{comparisonMetric33}": comparisonMetrics[33],
            "{comparisonMetric34}": comparisonMetrics[34],
            "{comparisonMetric35}": comparisonMetrics[35],
            "{comparisonMetric36}": comparisonMetrics[36],
            "{comparisonMetric37}": comparisonMetrics[37],
            "{comparisonMetric38}": comparisonMetrics[38],
            "{comparisonMetric39}": comparisonMetrics[39],
            "{comparisonMetric40}": comparisonMetrics[40],
            "{comparisonMetric41}": comparisonMetrics[41],
            "{comparisonMetric42}": comparisonMetrics[42],
            "{comparisonMetric43}": comparisonMetrics[43],
            "{comparisonMetric44}": comparisonMetrics[44],
            "{comparisonMetric45}": comparisonMetrics[45],
            "{comparisonMetric46}": comparisonMetrics[46],
            "{comparisonMetric47}": comparisonMetrics[47],
            "{comparisonMetric48}": comparisonMetrics[48],
            "{comparisonMetric49}": comparisonMetrics[49],
            "{comparisonMetric50}": comparisonMetrics[50],
        };
